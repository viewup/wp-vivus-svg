...
class Vsvg {
	 ...
	 *
	 * - Vsvg_Loader. Orchestrates the hooks of the plugin.
	 * - Vsvg_i18n. Defines internationalization functionality.
	 * - Vsvg_Admin. Defines all hooks for the admin area.
	 * - Vsvg_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Vsvg_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Vsvg_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Vsvg_Loader    Orchestrates the hooks of the plugin.
	 */
